...
class OdeSat:
    ...
    def ds(self, s, a, K_vals, t):
        ...
        intermediate_result = self.cT * Ki_vals * np.sign(K_vals)
        result = np.sum(a * intermediate_result, axis=1)
        return result
...
if __name__ == "__main__":
    ...
    result_name = f"abs_{file_name}_solveivp_{duration}s_{resolution}res"
