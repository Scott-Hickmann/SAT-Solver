...
print(
    "Color sets",
    [
        set([name_to_index_mapping[number] for number in color_set])
        ...
        for node in color_set:
            for neighbor in color_set:
                if graph[node][neighbor] != 0:
                    print(
                        f"Invalid graph, conflict between {chr(65 + node)} and {chr(65 + neighbor)}."
                    )
                    return False
    return True
